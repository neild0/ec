...
class Grammar(object):
    ...
    def sketchLogLikelihood(self, request, full, sk, context=Context.EMPTY, environment=[]):
        ...
        if sk.isHole:
            ...
            v = request.arguments[0]
            return self.sketchLogLikelihood(request.arguments[1], full.body, sk.body, context=context,
    ...
    def sketchllApplication(self, context, environment,
        ...
        if argumentRequests == []:
            ...
            argL, newContext = self.sketchLogLikelihood(argRequest, full_firstSketch, sk_firstSketch, context=context,
                                                        environment=environment)
                                            ...
                                            for a3 in expressions_of_size(at3, c3):
                                                ...
                                                for a4 in expressions_of_size(at3, size - cost - c1 - c2 - c3):
                                                    ...
                                                    new.append(Application(
                                                        Application(Application(Application(k, a1), a2), a3), a4))
                                            ...
                                            for a3 in expressions_of_size(at3, c3):
                                                ...
                                                for c4 in range(size - cost - c1 - c2 - c3):
                                                    for a4 in expressions_of_size(at3, c4):
                                                        a4 = a4.wrap_in_abstractions(nl4)
                                                        for a5 in expressions_of_size(at3,
                                                                                      size - cost - c1 - c2 - c3 - c4):
                                                            a5 = a4.wrap_in_abstractions(nl5)
                                                            new.append(Application(Application(
                                                                Application(Application(Application(k, a1), a2), a3),
                                                                a4), a5))
                    else:
